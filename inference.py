...
if __name__ == "__main__":
    ...
    src_vocab_size, dst_vocab_size = tokenizer.vocab_size + len(
        tokenizer.special_tokens_map), tokenizer.vocab_size + len(tokenizer.special_tokens_map)
    ...
    input_in = tokenizer(input_, padding="max_length", max_length=max_seq_len, truncation=True, return_tensors="pt")[
        "input_ids"]
